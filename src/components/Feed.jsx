...
const Feed = () => {
  ...
  const fetchCompanies = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://hrms-backend-22uq.onrender.com/api')}/companies`);
      if (response.ok) {
  ...
  const fetchPosts = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://hrms-backend-22uq.onrender.com/api')}/feed/${feedType}`);
      if (response.ok) {
        const data = await response.json();
        setPosts(data);
      }
  ...
  const handlePostSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://hrms-backend-22uq.onrender.com/api')}/feed`, {
        method: "POST",
  ...
  const handleLike = async (postId) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://hrms-backend-22uq.onrender.com/api')}/feed/${postId}/like`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleCommentSubmit = async (postId) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://hrms-backend-22uq.onrender.com/api')}/feed/${postId}/comment`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleDelete = async (postId) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://hrms-backend-22uq.onrender.com/api')}/feed/${postId}`, {
        method: "DELETE",
      });
